...
var nextWare = exports.nextWare = function nextWare(store) {
  return function (next) {
    return function (action) {
...
var _middleware = __webpack_require__(/*! ./middleware */ "./frontend/store/middleware.js");
...
var configureStore = function configureStore() {
  ...
  var store = (0, _redux.createStore)(_root_reducer2.default, preloadedState, _redux.applyMiddleware.apply(undefined, _toConsumableArray(middlewares)));
